...
TEXTS = {
    "ja": {
        ...
        "settings_accuracy": "認識精度",
        "settings_stt_model": "認識モデル:",
        "settings_vocabulary": "よく使う単語・固有名詞:",
        "settings_vocabulary_note": "認識させたい固有名詞・専門用語をスペース区切りで入力（精度向上・約120字まで）",
        "settings_sounds": "効果音を鳴らす（録音開始・停止・完了）",
    ...
    "en": {
        ...
        "settings_accuracy": "Accuracy",
        "settings_stt_model": "Speech model:",
        "settings_vocabulary": "Custom words / names:",
        "settings_vocabulary_note": "Space-separated proper nouns / jargon to recognize better (improves accuracy, ~120 chars)",
        "settings_sounds": "Play sound effects (record start / stop / done)",
